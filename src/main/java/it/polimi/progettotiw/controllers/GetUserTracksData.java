...
@WebServlet("/GetUserTracksData")
public class GetUserTracksData extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            List<Track> tracks = new TrackDAO(connection)
                    .findByUserOrdered(user.getUsername());
